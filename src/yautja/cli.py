...
def parser():
    ...
    p.add_argument('--wave-style', choices=WAVE_STYLES, default='trace', help='Trace, Rorschach filled/split/hollow, or digital distortion: blocks, shards, three-column vocoder (digital-circuit)')
