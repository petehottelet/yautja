...
def parser():
    ...
    p.add_argument('--target-fill', choices=['auto', 'filled', 'stroked'], default='auto', help='All reticles, including the analysis scan disk: original treatment, filled artwork, or hollow outlines')
