...
def parser():
    ...
    p.add_argument('--target-shape', type=resolve_target_shape, choices=TARGET_SHAPES, default='triangle', help='Animated reticle geometry; triangle by default. Hollow-cross has four L-shaped bands with an open center and arm ends; vector-lock and iron-sights remain aliases')
