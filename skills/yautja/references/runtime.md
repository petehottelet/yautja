...
For the optional subject-based heat simulation, model setup, GPU selection, and tracking limits, see [semantic.md](semantic.md). `--thermal luminance` does not import the machine-learning runtime or require model downloads.
