...
**Relic** inherits Focus's scene and grid. Violet broken triangles spawn on the selected figure, rise gently, then contract, spin and fade. Its dense upward code stays within each figure's width, behind every visible silhouette. Focus leaves code off. Both presets leave decorative weak-spot patches off; the optional capability remains available.
