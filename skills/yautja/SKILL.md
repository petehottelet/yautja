...
- [Focus, Relic and Murphy](references/focus.md): independent grid rotation/pulses, partial holographic edges, figure-bound ornaments, behind-code and readable captions. Focus has no code; Relic does. Both leave decorative weak-spot patches off unless requested.
